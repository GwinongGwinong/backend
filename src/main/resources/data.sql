...
VALUES ('test_host1@naver.com', 'test', '양춘식', '000101', '01012345678', '인천시 미추홀구 1층', '이미지 경로', '4.91', '양춘식 호스트 설명');
INSERT INTO host(email, password, name, birth, phone_number, address, image_path, rate, explanation)
VALUES ('test_host2@naver.com', 'test', '김준범', '000101', '01012345678', '인천시 미추홀구 1층',  '이미지 경로', '4.91', '김준범 호스트 설명');
INSERT INTO host(email, password, name, birth, phone_number, address, image_path, rate, explanation)
VALUES ('test_host3@naver.com', 'test', '정은주', '000101', '01012345678', '인천시 미추홀구 1층', '이미지 경로', '4.91', '정은주 호스트 설명');
INSERT INTO host(email, password, name, birth, phone_number, address, image_path, rate, explanation)
VALUES ('test_host4@naver.com', 'test', '임지영', '000101', '01012345678', '인천시 미추홀구 1층', '이미지 경로', '4.91', '임지영 호스트 설명');
INSERT INTO host(email, password, name, birth, phone_number, address, image_path, rate, explanation)
VALUES ('test_host5@inha.edu', 'test', '임춘식', '000101', '01012345678', '인천시 미추홀구 1층', '이미지 경로', '4.91', '임춘식 호스트 설명');
INSERT INTO guest(email, password, name, birth, phone_number, address, image_path, reviews, worked_days, earnings)
VALUES ('test_guest@inha.edu', 'test', '테스트 게스트', '000101', '01012345678', '인천시 미추홀구 1층', '이미지 경로', 17, 173, 420);
...
VALUES ('전북 임실치즈 전원주택(2/5층)', '전라북도 임실군', '이미지 경로', 10, 6, '2023-08-20', '2024-01-20', '전원주택', 30,
        1, '인터넷,에어컨,가스레인지,TV', '마당, 공용주차장, 바베큐, 파라솔', '전라북도 임실군 임실읍 치즈마을 1길 4 임실치즈마을', '38', '127', 'ON_GOING', 4.35, 1);
